            ...
            <section id="one">
                <div className="inner">
                    ...
                    <h4 style={{textAlign: "justify", fontWeight:"bold"}}>
                        ...
                        <br /><br />Users can create game posts, edit and filter them, join games, upload photos and chat with other users
                        <br /><br />Made with .Net Core on the backend, react on the frontend with CRUD functionality for communicating between the two                        
                    </h4>

                    <hr />                    
                    <h4 style={{textAlign: "center", color:'yellow'}}><i>.Net Core - react - typescript - MobX - Entity Framework - SqLite/MySql/SqlServer - Semantic-UI</i></h4>                                     
                    <hr />                    
